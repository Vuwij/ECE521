...
def best_search_hyperparameter():
    n_layers = 5
    n_hidden_units =  [221, 302, 341, 367, 457]
    with_dropout = 1
    learning_rate =  math.exp(-7.238)
    regularization =  math.exp(-7.7944)
    return n_layers, n_hidden_units, with_dropout, learning_rate, regularization
...
def build_neural_network():
    ...
    n_layers, n_hidden_units, with_dropout, learning_rate, regularization = best_search_hyperparameter()
